...
const int _thisPageIndex = 8; 

class IshiharaTest09 extends StatefulWidget {
  final IshiharaTestModel testModel;
  const IshiharaTest09({Key? key, required this.testModel}) : super(key: key);

  @override
  _IshiharaTest09State createState() => _IshiharaTest09State();
}

class _IshiharaTest09State extends State<IshiharaTest09> {
  final TestConfig config = testConfigs[8];
  ...
  Future<void> _handleNextTap() async {
    ...
    //Update model
    widget.testModel.updateAnswer(plateIndex: 8, selectedOption: selectedOption);
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(selectedOption == config.correctAnswerIndex
                ...
                : 'The correct answer is 45. Continue to the next plate!'),
            actions: [
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          IshiharaTest10(testModel: widget.testModel),
                    ),
                  );
                },
                style: ButtonStyle(
