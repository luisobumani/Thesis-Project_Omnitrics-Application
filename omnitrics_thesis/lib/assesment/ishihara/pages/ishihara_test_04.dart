...
const int _thisPageIndex = 3; 

class IshiharaTest04 extends StatefulWidget {
  final IshiharaTestModel testModel;
  const IshiharaTest04({Key? key, required this.testModel}) : super(key: key);
...
class _IshiharaTest04State extends State<IshiharaTest04> {
  ...
  Future<void> _handleNextTap() async {
    ...
    //Update model
    widget.testModel.updateAnswer(plateIndex: 3, selectedOption: selectedOption);
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(selectedOption == config.correctAnswerIndex
                ...
                : 'The correct answer is 5. Continue to the next plate!'),
            actions: [
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          IshiharaTest05(testModel: widget.testModel),
                    ),
                  );
                },
                style: ButtonStyle(
