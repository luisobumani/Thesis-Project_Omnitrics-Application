...
const int _thisPageIndex = 5; 

class IshiharaTest06 extends StatefulWidget {
  final IshiharaTestModel testModel;
  const IshiharaTest06({Key? key, required this.testModel}) : super(key: key);
...
class _IshiharaTest06State extends State<IshiharaTest06> {
  ...
  Future<void> _handleNextTap() async {
    ...
    //Update model
    widget.testModel.updateAnswer(plateIndex: 5, selectedOption: selectedOption);
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(selectedOption == config.correctAnswerIndex
                ...
                : 'The correct answer is 15. Continue to the next plate!'),
            actions: [
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          IshiharaTest07(testModel: widget.testModel),
                    ),
                  );
                },
                style: ButtonStyle(
