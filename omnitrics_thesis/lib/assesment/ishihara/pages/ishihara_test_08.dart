...
const int _thisPageIndex = 7; 

class IshiharaTest08 extends StatefulWidget {
  final IshiharaTestModel testModel;
  const IshiharaTest08({Key? key, required this.testModel}) : super(key: key);

  @override
  _IshiharaTest08State createState() => _IshiharaTest08State();
}

class _IshiharaTest08State extends State<IshiharaTest08> {
  final TestConfig config = testConfigs[7];
  ...
  Future<void> _handleNextTap() async {
    ...
    //Update model
    widget.testModel.updateAnswer(plateIndex: 7, selectedOption: selectedOption);
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(selectedOption == config.correctAnswerIndex
                ...
                : 'The correct answer is 2. Continue to the next plate!'),
            actions: [
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          IshiharaTest09(testModel: widget.testModel),
                    ),
                  );
                },
                style: ButtonStyle(
