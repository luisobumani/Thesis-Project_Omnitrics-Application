...
class _IshiharaTest03State extends State<IshiharaTest03> {
  final TestConfig config = testConfigs[2];
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(selectedOption == config.correctAnswerIndex
                ...
                : 'The correct answer is 8. Continue to the next plate!'),
            actions: [
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          IshiharaTest04(testModel: widget.testModel),
                    ),
                  );
                },
                style: ButtonStyle(
