...
const int _thisPageIndex = 9; 

class IshiharaTest10 extends StatefulWidget {
  final IshiharaTestModel testModel;
  const IshiharaTest10({Key? key, required this.testModel}) : super(key: key);

  @override
  _IshiharaTest10State createState() => _IshiharaTest10State();
}

class _IshiharaTest10State extends State<IshiharaTest10> {
  final TestConfig config = testConfigs[9];
  ...
  Future<void> _handleNextTap() async {
    ...
    //Update model
    widget.testModel.updateAnswer(plateIndex: 9, selectedOption: selectedOption);
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(selectedOption == config.correctAnswerIndex
                ...
                : 'The correct answer is 97. Continue to the next plate!'),
            actions: [
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          IshiharaTest11(testModel: widget.testModel),
                    ),
                  );
                },
                style: ButtonStyle(
