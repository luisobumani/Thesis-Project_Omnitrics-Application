              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10.h),
                    Text('1. WHAT INFORMATION DO WE COLLECT?', style: TextStyle(fontSize: 14.sp)),
                    Text('2. HOW DO WE PROCESS YOUR INFORMATION?', style: TextStyle(fontSize: 14.sp)),
                    Text('3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?', style: TextStyle(fontSize: 14.sp)),
                    Text('4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?', style: TextStyle(fontSize: 14.sp)),
                    Text('5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?', style: TextStyle(fontSize: 14.sp)),
                    Text('6. HOW LONG DO WE KEEP YOUR INFORMATION?', style: TextStyle(fontSize: 14.sp)),
                    Text('7. HOW DO WE KEEP YOUR INFORMATION SAFE?', style: TextStyle(fontSize: 14.sp)),
                    Text('8. DO WE COLLECT INFORMATION FROM MINORS?', style: TextStyle(fontSize: 14.sp)),
                    Text('9. WHAT ARE YOUR PRIVACY RIGHTS?', style: TextStyle(fontSize: 14.sp)),
                    Text('10. CONTROLS FOR DO-NOT-TRACK FEATURES', style: TextStyle(fontSize: 14.sp)),
                    Text('11. DO WE MAKE UPDATES TO THIS NOTICE?', style: TextStyle(fontSize: 14.sp)),
                    Text('12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?', style: TextStyle(fontSize: 14.sp)),
                    Text('13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?', style: TextStyle(fontSize: 14.sp)),
                    SizedBox(height: 20),
                    ...
                    Text('• names', style: TextStyle(fontSize: 14.sp)),
                    Text('• email addresses', style: TextStyle(fontSize: 14.sp)),
                    Text('• passwords', style: TextStyle(fontSize: 14.sp)),
                    Text('• usernames', style: TextStyle(fontSize: 14.sp)),
                    Text('• gender', style: TextStyle(fontSize: 14.sp)),
                    SizedBox(height: 10.h),
                    Text(
                      'Sensitive Information. When necessary, with your consent or as otherwise permitted by applicable law, we process the following categories of sensitive information:',
                      style: TextStyle(fontSize: 14.sp),
                    ),
                    Text('• health data', style: TextStyle(fontSize: 14.sp)),
                    SizedBox(height: 10.h),
                    Text(
                    ...
                    SizedBox(height: 10.h),
                    Text('Purple Inc.', style: TextStyle(fontSize: 14.sp)),
                    Text('808 San Marcelino Street 1000 Manila Metro Manila', style: TextStyle(fontSize: 14.sp)),
                    Text('Manila, Metro Manila 1004', style: TextStyle(fontSize: 14.sp)),
                    Text('Philippines', style: TextStyle(fontSize: 14.sp)),
                    SizedBox(height: 20.h),
